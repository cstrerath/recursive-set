import { LogicParser, Formula, Variable, Constant, Negation, BinaryFormula, Operator } from './propososial-logic-parser';
import { RecursiveSet, RecursiveTuple, StructuralValue } from '../src/recursive-set';
